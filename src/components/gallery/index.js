...
const Season = ({ season }) => {
    ...
    const resize = () => {
        ...
        for (const child of children) {
            ...
            const distance = sliderBound.left - bond.left - child.clientWidth / 2 + slider.clientWidth / 2;
            if (distance > 0) {
    ...
    return (
        <div className="seasonContainner">
            ...
            <ScrollContainer className="seasonSliderContainner" id={"slider" + season.title} ref={sliderref}>
