...
const BlockParticles = () => {
                ...
                animations: [
                    {
                        elements: {
                            e2uFyStl6sQ2: {
                                transform: {
                                    data: {
                                        o: { x: 141.5, y: 147.5, type: "corner" },
                                        t: { x: -13.5, y: -13.5 },
                                    },
                                    keys: {
                                        s: [
                                            { t: 0, v: { x: 1, y: 1 }, e: [0.42, 0, 0.58, 1] },
                                            { t: 1500, v: { x: 1.5, y: 1.5 }, e: [0.42, 0, 0.58, 1] },
                                            { t: 2900, v: { x: 1, y: 1 } },
                                        ],
                                    },
                                },
                            ...
                            e2uFyStl6sQ3: {
                                transform: {
                                    data: {
                                        o: { x: 783, y: 73, type: "corner" },
                                        t: { x: -29, y: -29 },
                                    },
                                    keys: {
                                        s: [
                                            { t: 0, v: { x: 1, y: 1 }, e: [0.42, 0, 0.58, 1] },
                                            { t: 1500, v: { x: 0.3, y: 0.3 }, e: [0.42, 0, 0.58, 1] },
                                            { t: 2900, v: { x: 1, y: 1 } },
                                        ],
                                    },
                                },
                            ...
                            e2uFyStl6sQ5: {
                                transform: {
                                    data: {
                                        o: { x: 184, y: 306, type: "corner" },
                                        t: { x: -29, y: -29 },
                                    },
                                    keys: {
                                        s: [
                                            { t: 0, v: { x: 1, y: 1 }, e: [0.42, 0, 0.58, 1] },
                                            { t: 1400, v: { x: 0.5, y: 0.5 }, e: [0.42, 0, 0.58, 1] },
                                            { t: 2900, v: { x: 1, y: 1 } },
                                        ],
                                    },
                                },
                            ...
                            e2uFyStl6sQ8: {
                                transform: {
                                    data: {
                                        o: { x: 43.5, y: 143, type: "corner" },
                                        t: { x: -43.5, y: -143 },
                                    },
                                    keys: {
                                        s: [
                                            { t: 0, v: { x: 1, y: 1 }, e: [0.42, 0, 0.58, 1] },
                                            { t: 1500, v: { x: 2, y: 2 }, e: [0.42, 0, 0.58, 1] },
                                            { t: 2900, v: { x: 1, y: 1 } },
                                        ],
                                    },
                                },
                            ...
                            e2uFyStl6sQ10: {
                                transform: {
                                    data: {
                                        o: { x: 26.5, y: 418.5, type: "corner" },
                                        t: { x: -8.5, y: -435.5 },
                                    },
                                    keys: {
                                        s: [
                                            { t: 0, v: { x: 1, y: 1 }, e: [0.42, 0, 0.58, 1] },
                                            { t: 1400, v: { x: 2, y: 2 }, e: [0.42, 0, 0.58, 1] },
                                            { t: 2900, v: { x: 1, y: 1 } },
                                        ],
                                    },
                                },
                            ...
                            e2uFyStl6sQ11: {
                                transform: {
                                    data: {
                                        o: { x: 1016.5, y: 424.5, type: "corner" },
                                        t: { x: -1024.5, y: -435.5 },
                                    },
                                    keys: {
                                        s: [
                        ...
                        s: "|",
                    },
                ],
                options: "MJDAxMDg4MmY4MDgxNmCU3ZjgxMmY0NzJmNzkM3YzZlNzEyZjhh",
            },
            "__SVGATOR_PLAYER__",
            window,
            document
    ...
    return (
        <svg
            className="blockParticles"
            id="e2uFyStl6sQ1"
            viewBox="0 0 1033 444"
            shape-rendering="geometricPrecision"
            text-rendering="geometricPrecision"
        >
            <rect id="e2uFyStl6sQ2" width="27" height="27" rx="0" ry="0" transform="translate(128 134)" fill="#c93f3f" />
            <rect id="e2uFyStl6sQ3" width="58" height="58" rx="0" ry="0" transform="translate(754 44)" fill="#2bb9b9" />
            <rect id="e2uFyStl6sQ4" width="58" height="58" rx="0" ry="0" transform="translate(845 306)" fill="#c93f3f" />
            <rect id="e2uFyStl6sQ5" width="58" height="58" rx="0" ry="0" transform="translate(155 277)" fill="#2bb9b9" />
            <g id="e2uFyStl6sQ6">
                <rect width="58" height="58" rx="0" ry="0" transform="translate(256 90)" fill="#54c936" />
            </g>
            <path id="e2uFyStl6sQ8" d="M35,134.5h17v17h-17v-17Z" fill="#54c936" />
            <path id="e2uFyStl6sQ9" d="M213,25h17v17h-17v-17Z" fill="#628bff" />
            <path id="e2uFyStl6sQ10" d="M0,427h17v17h-17v-17Z" transform="translate(18-17)" fill="#2bb9b9" />
            <path id="e2uFyStl6sQ11" d="M1016,427h17v17h-17v-17Z" transform="translate(-8-11)" fill="#54c936" />
            <rect id="e2uFyStl6sQ12" width="17" height="17" rx="0" ry="0" transform="translate(458 7)" fill="#d9d9d9" />
            <rect id="e2uFyStl6sQ13" width="17" height="17" rx="0" ry="0" transform="translate(958 93)" fill="#d9d9d9" />
            <rect id="e2uFyStl6sQ14" width="17" height="17" rx="0" ry="0" transform="translate(643 17)" fill="#54c936" />
            <rect id="e2uFyStl6sQ15" width="29" height="29" rx="0" ry="0" transform="translate(952 204)" fill="#54c936" />
        </svg>
    );
};
