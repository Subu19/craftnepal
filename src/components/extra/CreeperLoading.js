  ...
  return (
    ...
    >
      <defs>
        ...
        >
          <feGaussianBlur
            id="eH7dN3ypZfA8-filter-drop-shadow-0-blur"
            in="SourceAlpha"
            stdDeviation="4,4"
          />
          <feOffset
            id="eH7dN3ypZfA8-filter-drop-shadow-0-offset"
            dx="0"
            dy="0"
            result="tmp"
          />
          <feFlood
            id="eH7dN3ypZfA8-filter-drop-shadow-0-flood"
            flood-color="#16c235"
          />
          <feComposite
            id="eH7dN3ypZfA8-filter-drop-shadow-0-composite"
            operator="in"
            in2="tmp"
          />
          <feMerge id="eH7dN3ypZfA8-filter-drop-shadow-0-merge" result="result">
            ...
            <feMergeNode
              id="eH7dN3ypZfA8-filter-drop-shadow-0-merge-node-2"
              in="SourceGraphic"
            />
          </feMerge>
        </filter>
      ...
      <g clip-path="url(#eH7dN3ypZfA16)">
        <g>
          ...
          <rect
            ...
            rx="0"
            ry="0"
            transform="matrix(0-1 1 0 34 50)"
            fill="#0b3f22"
          />
          <rect
            width="36"
            ...
            rx="0"
            ry="0"
            transform="matrix(0-1 1 0 135 50)"
            fill="#0b3f22"
          />
          <rect
            width="36"
