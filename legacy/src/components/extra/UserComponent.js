    ...
    return (
        <div className="userComponent">
            <dialog ref={userMenuref} className="userDialog">
                <div className="dialogContainner">
                    <div className="dialogHeader">
                        ...
                        <i class="fa fa-window-close dialog-close" onClick={() => userMenuref.current.close("")}></i>
                    </div>
            ...
            {user == null || gettingUser || user.err ? (
                <div className="mybutton" onClick={() => (window.location = process.env.REACT_APP_BASE_URL + process.env.REACT_APP_LOGIN)}>
